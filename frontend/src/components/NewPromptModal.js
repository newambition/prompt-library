...
function NewPromptModal({ isOpen, onClose, onSubmit, availableTags = [] }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg bg-surface glass border border-light p-6 rounded-xl shadow-xl relative flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <h2 className="text-xl font-semibold mb-6 text-light text-center">Create New Prompt</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto flex-grow pr-2">
          <div>
            ...
            <input
              ...
              required
              className="w-full border border-light rounded-md p-2.5 bg-dark text-light focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows="6"
              className="w-full border border-light rounded-md p-2.5 bg-dark text-light focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary resize-none"
          ...
          <div>
            ...
            <div className="flex gap-2 items-center">
              <input
                ...
                className="flex-grow p-2.5 border border-light rounded-md text-sm bg-dark text-light focus:outline-none focus:ring-2 focus:ring-secondary focus:border-secondary"
              ...
              <div className="relative">
                ...
                {showThemePicker && (
                  <div className="absolute top-full right-0 mt-1 z-50 bg-dark border border-light rounded-md shadow-lg p-2 grid grid-cols-3 gap-1" style={{minWidth: '120px'}}>
